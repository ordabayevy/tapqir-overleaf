...
$x_c$ & target molecule position on the $x$-axis & $[-1/2, 1/2]^{\mathsf{AOI}[N] \times \mathsf{frame}[F]}$ \rule{0pt}{3ex} \\
$y_c$ & target molecule position on the $y$-axis & $[-1/2, 1/2]^{\mathsf{AOI}[N] \times \mathsf{frame}[F]}$ \rule{0pt}{3ex} \\
\bottomrule
\end{tabular}
\end{table}
\clearpage
