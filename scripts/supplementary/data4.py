...
description.name = (
    "Supplementary File 4: No target-specific binding and varying non-specific binding rate "
    "simulation parameters and corresponding fit values"
)

with pd.ExcelWriter("supplementary/data4.xlsx", engine="xlsxwriter") as writer:
