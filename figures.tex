...
% figure 5
% add triangle brackets to pspecific
% credible region abbreviation
\begin{figure}[h]
\centering
...
% figure 6
% make target . binder closer (remove extra space)
% simulated target ...
% Tapqir p(specific)
% posterior samples from p(specific)
\begin{figure}[h]
\centering
...
\end{figure}
% "fit" --> inferred from Tapqir analysis
% fix paging
% do 2000 simulations
\clearpage
\pagebreak
