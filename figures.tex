...
% figure 2
% 2D image, x,y labels
% Proper name for spotpicker
% spot 1 & spot 2 labels in fig3
\begin{figure}[h]
\centering
...
% figure 3
% remove units
% remove b tick labels and make a and b closer
\begin{figure}[h]
\centering
...
% figure 7
% change color in b to green
% in (d) put Tapqir first
% plot ka and kns on the same scale
% in (d) use other color (gray)
% add to Methods how CI is calculated
% in (b) and (c) add Tapqir and spot-picker labels
% in (b) use purple and dark yellow as in fig1
\begin{figure}[h]
\centering
