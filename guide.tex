...
\paragraph{Algorithm 3.} Variational sampling distribution $q$ (add more description, in Pyro this is called the guide).
...
\Initialize{
    ...
    $\mu^b_\mathrm{mean} \gets \mathsf{mean}(D)^{\mathrm{AOI}[N]}$, \quad $\mu^b_\mathrm{mean} \in \mathbb{R}_{>0}^{\mathrm{AOI}[N]}$ \\
    $\sigma^b_\mathrm{mean} \gets 1^{\mathrm{AOI}[N]}$, \quad $\sigma^b_\mathrm{mean} \in \mathbb{R}_{>0}^{\mathrm{AOI}[N]}$ \\
    $b_\mathrm{mean} \gets \mathsf{mean}(D)^{\mathrm{AOI}[N] \times \mathrm{frame}[F]}$, \quad $b_\mathrm{mean} \in \mathbb{R}_{>0}^{\mathrm{AOI}[N] \times \mathrm{frame}[F]}$ \\
    ...
    $m_\mathrm{prob} \gets 0.5^{\mathrm{spot}[K] \times \mathrm{AOI}[N] \times \mathrm{frame}[F]}$, \quad $m_\mathrm{prob} \in [ 0, 1 ]^{\mathrm{spot}[K] \times \mathrm{AOI}[N] \times \mathrm{frame}[F]}$ \\
