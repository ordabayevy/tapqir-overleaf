% things to consider adding in revision:
% - discussion: explain why we did not go for a non-causal/non-physics-based neural net type approach: physical interpretability of parameters provides a sanity check
% - discussion: explain how method could be used for smFRET, e.g., as a pre-processing step for ebFRET.
