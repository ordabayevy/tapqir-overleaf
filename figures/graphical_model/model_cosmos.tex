...
\begin{tikzpicture}
  ...
  \node[const, above=2.8 of b, xshift=0.5cm]  (bb) {$\beta^b$} ; %
  ...
  % Factors
  \factor[above=of D] {D-f} {left:$\mathcal{CG}$} {} {} ; %
  \factor[above=0.6 of b] {b-f} {left:$\mathcal{G}$} {mb,bb} {b} ; %
  \factor[above=0.6 of h] {h-f} {left:$\mathcal{HN}$} {mh,bh} {h} ; %
  \factor[above=0.6 of w] {w-f} {left:$\mathcal{AB}$} {mw,nw} {w} ; %
  \factor[above=0.6 of x] {x-f} {left:$\mathcal{AB}$} {mxy,nxy} {x} ; %
  \factor[above=0.6 of y] {y-f} {left:$\mathcal{AB}$} {mxy,nxy} {y} ; %
